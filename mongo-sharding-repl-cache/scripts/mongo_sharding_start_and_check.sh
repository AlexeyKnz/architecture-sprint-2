...
# Тестирование
mongo_test_shard_doc_count shard1_node1 27018  # Проверка shard1_node1
mongo_test_shard_doc_count shard1_node2 27019  # Проверка shard1_node2
mongo_test_shard_doc_count shard1_node3 27020  # Проверка shard1_node3
mongo_test_shard_doc_count shard2_node1 27021  # Проверка shard2_node1
mongo_test_shard_doc_count shard2_node2 27022  # Проверка shard2_node2
mongo_test_shard_doc_count shard2_node3 27023  # Проверка shard2_node3
